...
public class OAuth2Configuration extends AuthorizationServerConfigurerAdapter {
    ...
    @Autowired
    public OAuth2Configuration(@Qualifier("authManagerBean") AuthenticationManager authenticationManager) {
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients.inMemory().withClient("webapp").secret(passwordEncoder.encode("webapp")).authorizedGrantTypes("implicit", "refresh_token", "password")
                ...
                .and()
                .withClient("server").secret(passwordEncoder.encode("admin")).authorizedGrantTypes("refresh_token", "authorization_code")
